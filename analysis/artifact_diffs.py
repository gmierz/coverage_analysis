...
def get_diff(old_link, new_link):
	...
	save_json(differences, tests_dict, sfiles_dict)

'''
old_link = 'C:/Users/Gregory/Documents/mozwork/diffwork/grcov_lcov_output_stdout_1.info'
new_link = 'C:/Users/Gregory/Documents/mozwork/diffwork/grcov_lcov_output_stdout_2.info'
old_artifact = None
new_artifact = None
'''
...
if __name__ == '__main__':
	...
	for testsuite_chunk in dirs:
		os.chdir(os.path.join(starter_dir, testsuite_chunk))
		older_path = os.path.join(starter_dir, testsuite_chunk, 'grcov_lcov_output_stdout.info')
		newer_path = os.path.join(starter_dir, testsuite_chunk, 'grcov_lcov_output_stdout1.info')
		get_diff(older_path, newer_path)